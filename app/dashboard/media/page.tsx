...
export default async function MediaLibraryPage(){
  ...
  return <DashboardShell activePath="/dashboard/media" description="Upload, reuse, replace, and audit protected learning assets." title="Media Library" userLabel={displayName}><CourseMediaLibrary media={media}/></DashboardShell>;
}
