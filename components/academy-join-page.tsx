          ...
          <div className={styles.cardHeader}>
            ...
            <p>
              {isSubscription
                ...
                : "Create your account below. After you sign in, the student dashboard will ask for your XM client ID and verify it automatically. Returning students should use Sign In."}
            </p>
          </div>
