...
export default async function StudentCoursesPage({
  ...
  const [{ data: courseRows }, { data: progressRows }] = await Promise.all([
    ...
    supabase
      ...
      .select("course_id,lesson_id,position_seconds,is_started,is_completed,last_activity_at")
      .eq("trader_id", app.trader_id)
      .eq("student_user_id", user.id),
  ]);
    ...
    <main className={styles.page}>
      <nav className={styles.nav}>
        ...
        <div className={styles.navActions}>
          ...
          <Link href={`${base}${suffix}`}>Account</Link>
      ...
      <div className={styles.hero}>
        ...
        <h1>My Learning</h1>
        <p>
          Resume protected lessons, track your progress, and revisit completed
          courses.
        </p>
      </div>
          ...
          <div className={styles.resumeCard}>
            ...
            <div className={styles.resumeBody}>
              ...
              <p className={styles.resumeProgressLabel}>
                {continueCourse.percent}% · {continueCourse.lessonCount} required
                lesson{continueCourse.lessonCount === 1 ? "" : "s"}
              </p>
              <Link
      ...
      <section className={styles.section}>
        ...
        {courses.length > 0 ? (
            ...
            {courses.map((course) => (
              ...
              >
                ...
                <div className={styles.cardBody}>
                  ...
                  <p className={styles.cardProgressLabel}>{course.percent}%</p>
                  {course.complete ? (
          ...
          <div className={styles.empty}>
            ...
            <p>
              Your mentor is preparing the learning library or access has not
              been assigned.
            </p>
          </div>
        )}
