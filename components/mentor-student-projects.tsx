...
function ProjectForm({
  ...
  initial?: Partial<StudentProject>;
    ...
    >
      ...
      <label style={lbl}>
        ...
        <select name="category" required defaultValue={initial?.category ?? "web-app"} style={inp}>
          {STUDENT_PROJECT_CATEGORIES.map((c) => (
...
export function MentorStudentProjects({ projects }: { projects: StudentProject[] }) {
              ...
              <div style={{ display: "flex", alignItems: "flex-start", gap: "1rem" }}>
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  <div style={{ display: "flex", alignItems: "center", gap: "0.5rem", flexWrap: "wrap" }}>
                    ...
                    <span style={badge("var(--surface-2)", "var(--muted)")}>{studentProjectCategoryLabel(p.category)}</span>
