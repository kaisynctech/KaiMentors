...
| Student registration and verification | Complete | Tenant-aware registration, verification attempts, review workflows, status states, and audit logs. Dual-role user support: traders with student applications can access the student portal; academy login accepts both mentors and students of the academy. |
