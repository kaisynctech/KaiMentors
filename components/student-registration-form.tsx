        ...
        <>
          <div className={styles.reviewBox}>
            ...
            <p>
              ...
              next screen to activate your account and open your student dashboard.
              {!isSubscription
                ? " There you enter your XM client ID so we can verify you automatically."
                : ""}
            </p>
          </div>
          {isSubscription ? (
          ...
          <label className={styles.consent}>
            ...
            {isSubscription ? (
              ...
              <span>
                I have read and understood the above. I consent to my XM client ID
                being verified automatically from the student dashboard. I accept
